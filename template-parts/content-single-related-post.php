                    ...
                    <div class="container">
                        <div class="wrapper">
                            ...
                            <div id="rp-item-wr">
                                ...
                                ?>
                                    <div class="item">
                                        <h3 class="head-smaller fw-500"><a href="<?php echo esc_html(get_the_permalink($post_id)); ?>" title="<?php echo esc_attr(get_the_title($post_id)); ?>"><?php echo get_the_title($post_id); ?></a></h3>
